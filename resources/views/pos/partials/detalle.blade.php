                ...
                <tbody>
                    ...
                    <tr>
                        <td class="text-center table-th">
                            ...
                            <span>
                                <img src="{{asset('storage/producto/' .$item->attributes[0])}}" alt="Imàgen de producto" height="90" width="90px" class="rounded">
                            </span>
                            @endif
                        </td>
                        <td><h6>{{$item->nombre}}</h6></td>
                        <td class="text-center">Bs{{number_format($item->precio,2)}}</td>
                        <td>
                            <input type="number" name="" id="r{{$item->id}}"
                        ...
                        @csrf
                            ...
                            data-toggle="modal" data-target="#ModalDeleteDetalle{{$item->id}}" 
