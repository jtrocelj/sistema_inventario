    ...
    <div class="card">
            ...
            <div class="row">
              ...
              <div class="card-header bg-transparent border-0">
                <h3 class="text-white mb-0">Reporte de ventas por día</h3> @include('common.searchbox')
              </div>
                  <div class="table-responsive mt--6">
                                              ...
                                              <a class="btn btn-outline-success" href="{{route('excel') }}">Exportar a Excel<i class="fas fa-file-excel"></i></a>

                                              <a class="btn btn-outline-danger"href="{{route('pdf')}}">
